...
public static class ConfigureServices
{
    ...
    public static IServiceCollection AddEventBus(this IServiceCollection services, IConfigurationRoot configuration)
    {
        ...
        services.AddMassTransit<IEventBus>(x =>
        {
            ...
            UsingRabbitMq(x, config, queueConfiguration);
            ...
            x.AddRider(rider =>
            {
                ...
                rider.UsingKafka((context, k) =>
                {
                    ...
                    k.TopicEndpoint<string, ITaskEvent>("topic-name", "consumer-group-name", e =>
                    {
    ...
    private static void UsingRabbitMq(IBusRegistrationConfigurator<IEventBus> x, RabbitMqSettings config, IQueueConfiguration queueConfiguration)
    {
